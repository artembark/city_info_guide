                    ...
                    children: <TableRow>[
                        ...
                        ControlButton(
                            onPressed: () async {
                              final placemark = PlacemarkMapObject(
                                  ...
                                  point: (await controller.getCameraPosition())
                                      .target,
                                  opacity: 0.7,
                      ...
                      TableRow(children: <Widget>[
                        ...
                        ControlButton(
                            ...
                            title:
                                'Night mode: ${_enabledText(nightModeEnabled)}')
                      ]),
                      TableRow(children: <Widget>[
                        ControlButton(
                            onPressed: () async {
                      ...
                      TableRow(children: <Widget>[
                        ControlButton(
                            ...
                            title:
                                'Indoor mode: ${_enabledText(indoorEnabled)}'),
                        ControlButton(
                            onPressed: () async {
                              setState(() {
                                liteModeEnabled = !liteModeEnabled;
                            ...
                            title:
                                'Lite mode: ${_enabledText(liteModeEnabled)}')
                      ]),
                      TableRow(children: <Widget>[
                        ControlButton(
                            onPressed: () async {
